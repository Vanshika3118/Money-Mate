...
function renderExpenseRow(expense) {
    ...
    deleteBtn.addEventListener('click', function () {
        ...
        fetch(`/delete/${expense._id}`, {
            ...
            .then(response => {
                if (response.ok) {
                    // Remove expense from the UI and update total amount
    ...
    dateCell.textContent = new Date(expense.Date).toLocaleDateString(); // Ensure proper date formatting
...
addBtn.addEventListener('click', function (event) {
    ...
    .then(response => response.json()) // Expect the server to return the newly created expense
    .then(newExpense => {
